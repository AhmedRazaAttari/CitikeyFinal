            ...
            <View style={{ alignItems: "center" }}>
                ...
                <View style={{ width: Dimensions.get("screen").width, height: "65%", backgroundColor: "white", borderTopRightRadius: 50, borderTopLeftRadius: 60, padding: 10 }}>
                    ...
                    <View style={{ alignItems: "center" }}>
                        ...
                        <TextInput placeholder="Password" onChangeText={val => setPassword(val)} style={{ width: "95%", height: 50, borderRadius: 50, borderWidth: 1, borderColor: "lightgrey", marginTop: 15, paddingLeft: 20 }} />
